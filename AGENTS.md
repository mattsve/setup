...
|------|---------|---------------|
| `pve1` | Proxmox VE server | NUT server enabled, package updates |
...
### Roles
- **nut** - Custom role for Network UPS Tools server configuration with defaults, tasks, and Jinja2 templates
